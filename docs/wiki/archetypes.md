We have three diagnostic domains, which create a 3D cube with **8 distinct octants**. These are the 8 "Relationship Species" or Archetypes that the Eros Vector maps.

| Axis | Domain | + Pole | − Pole | Question |
| --- | --- | --- | --- | --- |
| Y | Architecture | Interdependent | Autonomous | How do you build your life? |
| X | Drive | Erotic | Emotional | Why are you connecting? |
| Z | Method | Directed | Organic | How does it actually happen? |

Each domain is a single dial. The pole names are the clean labels; the synonym clusters below are the extended meaning you should hear behind them.

### Architecture — How do you build your life?

- **+ Interdependent:** merged, anchored, couple-centric, prioritized.
- **− Autonomous:** independent, solo, individual-centric, sovereign.

### Drive — Why are you connecting?

- **+ Erotic:** sexual variety, physical play, recreational.
- **− Emotional:** romantic depth, chosen family, intertwined.

### Method — How does it actually happen?

- **+ Directed:** proactive, app-driven, explicit rules, scheduled, aimed.
- **− Organic:** spontaneous, emergent, fluid vibes, authentic, growing.

"Directed" is deliberate outreach and aiming—not "intentional" as the opposite of accidental. "Organic" is emergent and in-the-moment—not unintended.
...
*Interdependent + Erotic + Directed*
...
*Autonomous + Erotic + Directed*

You are your own primary. You have no desire to merge your life or logistics with a partner, but you have a high erotic drive for sexual variety and play. You are highly directed about how you get your needs met—using apps, going to specific events, or setting up clear, casual arrangements. You want the fun and the thrill without the emotional heavy lifting or the logistical entanglement of a merged life.

#### 6. The Free Agent (-Y, +X, -Z)

*Autonomous + Erotic + Organic*
...
When the user's dot lands in one of these octants, the app doesn't just give them the name; it gives them the paragraph.

More importantly, because we have the **Dual-Mode** (Scouting vs. Bound), a user might get two different archetypes. For example:

*   **Scouting Dot:** Lands in "The Free Agent" (-Y, +X, -Z). *When single, I flow through permissive tribes looking for spontaneous casual play.*
*   **Bound Dot:** Lands in "The Anchored Play Couple" (+Y, +X, +Z). *When pair-bonded, I become highly structured and directed about how we play together as a team.*

The friction between those two archetypes tells the user *exactly* how their operating system reboots when they transition from single to coupled.
