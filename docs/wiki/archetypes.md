...
Working catalog for the 16 Eros Vector archetypes.

These archetypes are **orientation patterns**, not identities, diagnoses, or prescriptions. Each names one orthant of the four-axis model. A person may recognize themselves in several descriptions, sit near a boundary, or move between orthants across Scouting, Bound, Past, Present, Aspiration, and Horizon contexts.

The names are memorable handles for the geometry. The coordinates and descriptions are the actual definition.
...
Signs are always written in **W / X / Y / Z order**. For example, `− + − +` means Autonomous + Recreational + Permeable + Directed.

The `+` and `−` signs are coordinates, not judgments. Neither side is inherently healthier, more evolved, or more ethical.

A **relational core** is a bonded group of two or more people around which significant commitment, priority, or shared life is organized. A **relational system** is the wider web of connections within and beyond any such core.

## The 16-orthant truth table

| #   | W              | X            | Y         | Z        | Archetype                |
| --- | -------------- | ------------ | --------- | -------- | ------------------------ |
| 1   | Interdependent | Recreational | Contained | Directed | Structured Play Unit     |
| 2   | Interdependent | Recreational | Contained | Organic  | Spontaneous Play Unit    |
| 3   | Interdependent | Recreational | Permeable | Directed | Integrated Play Partners |
| 4   | Interdependent | Recreational | Permeable | Organic  | Tribal Erotic            |
| 5   | Interdependent | Romantic     | Contained | Directed | Closed Builder           |
| 6   | Interdependent | Romantic     | Contained | Organic  | Closed Nest              |
| 7   | Interdependent | Romantic     | Permeable | Directed | Poly Architect           |
| 8   | Interdependent | Romantic     | Permeable | Organic  | Chosen Family            |
| 9   | Autonomous     | Recreational | Contained | Directed | Solo Player              |
| 10  | Autonomous     | Recreational | Contained | Organic  | Guarded Free Agent       |
| 11  | Autonomous     | Recreational | Permeable | Directed | Open Explorer            |
| 12  | Autonomous     | Recreational | Permeable | Organic  | Free Agent               |
| 13  | Autonomous     | Romantic     | Contained | Directed | Focused Romantic         |
| 14  | Autonomous     | Romantic     | Contained | Organic  | Lone Wolf Romantic       |
| 15  | Autonomous     | Romantic     | Permeable | Directed | Solo Polyamorist         |
| 16  | Autonomous     | Romantic     | Permeable | Organic  | Relationship Anarchist   |
...
### 1. Structured Play Unit `+ + + +`

_Interdependent + Recreational + Contained + Directed_
...
### 2. Spontaneous Play Unit `+ + + −`

_Interdependent + Recreational + Contained + Organic_
...
### 3. Integrated Play Partners `+ + − +`

_Interdependent + Recreational + Permeable + Directed_
...
_Interdependent + Recreational + Permeable + Organic_
...
These patterns organize life around a merged relational core while prioritizing emotional or romantic depth.

### 5. Closed Builder `+ − + +`

_Interdependent + Romantic + Contained + Directed_
...
_Interdependent + Romantic + Contained + Organic_
...
_Interdependent + Romantic + Permeable + Directed_
...
_Interdependent + Romantic + Permeable + Organic_
...
These patterns preserve individual sovereignty while seeking play and erotic variety.

### 9. Solo Player `− + + +`

_Autonomous + Recreational + Contained + Directed_
...
### 10. Guarded Free Agent `− + + −`

_Autonomous + Recreational + Contained + Organic_
...
_Autonomous + Recreational + Permeable + Directed_
...
_Autonomous + Recreational + Permeable + Organic_
...
These patterns preserve individual sovereignty while prioritizing emotional or romantic depth.

### 13. Focused Romantic `− − + +`

_Autonomous + Romantic + Contained + Directed_
...
### 14. Lone Wolf Romantic `− − + −`

_Autonomous + Romantic + Contained + Organic_
...
_Autonomous + Romantic + Permeable + Directed_
...
### 16. Relationship Anarchist `− − − −`

_Autonomous + Romantic + Permeable + Organic_
...
Flipping all four signs produces eight structural oppositions:

| Archetype                | Opposite               |
| ------------------------ | ---------------------- |
| Structured Play Unit     | Relationship Anarchist |
| Spontaneous Play Unit    | Solo Polyamorist       |
| Integrated Play Partners | Lone Wolf Romantic     |
| Tribal Erotic            | Focused Romantic       |
| Closed Builder           | Free Agent             |
| Closed Nest              | Open Explorer          |
| Poly Architect           | Guarded Free Agent     |
| Chosen Family            | Solo Player            |

Opposites are not enemies and one is not healthier than the other. The pairing simply shows the maximum coordinate distance between two orthants.

## Interpretation notes

- **Names are prototypes.** A person in Closed Builder may be monogamous, polyfidelitous, or part of another closed relational core.
- **Magnitude matters.** Someone barely inside an orthant may feel less represented by its name than someone near its outer corner.
- **Context matters.** Scouting and Bound modes may resolve to different archetypes at the same time point.
- **Time matters.** Movement between archetypes can be more informative than any single label.
- **Boundaries are continuous.** A score of zero is a genuine balance point, not a failure to classify.
- **Ethics are separate.** Consent, honesty, care, and agreement-keeping are not inferred from an orthant.
