...
Working specification for the Eros Vector orientation model.

**Product framing:** a four-axis relationship map across time.
...
A **relational core** is a bonded group of two or more people around which significant commitment, priority, or shared life is organized. It may be a dyad, triad, quad, closed polycule, or another configuration; the term does not prescribe group size or exclusivity.
...
Life is organized around a merged or prioritized relational core — a home base that shares significant commitment, logistics, or life decisions.

**Synonym cluster:** merged, anchored, core-centered, prioritized, home base, shared logistics, collective life-building.

**Examples:** nesting partners; an anchored relational core with more peripheral connections; shared housing, finances, or family-building within a bonded group.

### − Autonomous

The individual is sovereign. There is no desire to organize living or financial life around partners or a bonded group; independence is the architecture.

**Synonym cluster:** independent, solo, individual-centric, sovereign, own primary, unmerged logistics.

**Examples:** solo poly; living alone while dating deeply; refusing to share housing or primary status.
...
Connections and structures are aimed, scheduled, negotiated, and built on purpose — proactive outreach and explicit design.

**Synonym cluster:** proactive, app-driven, explicit rules, scheduled, aimed, blueprint, deliberate outreach.

**Examples:** dating apps with clear intent; club nights planned with partners; negotiated agreements and defined roles.

### − Organic

Connections emerge from vibe, tribe, and circumstance — spontaneous, fluid, grown rather than engineered.

**Synonym cluster:** spontaneous, emergent, fluid vibes, authentic, growing, garden-not-blueprint, permissive social flow.

**Examples:** flirtation that combusts in a permissive friend group; bonds that evolve without a prior plan; “it just happened.”

### Does measure

- Process: how structures and connections form and are maintained.
- Planned/aimed vs. emergent/in-the-moment.
...
- Not the 16 orthant / archetype catalog (separate article).
- Not the survey item bank (separate article / Content tooling).
