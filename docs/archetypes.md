We have the 3 axes, which create a 3D cube with **8 distinct octants**. These are the 8 "Relationship Species" or Archetypes that the Eros Vector maps. 

Here are the paragraph definitions for all 8 mapped types, based on their coordinates (+ or - on Y, X, Z). 
...
*Structure + Hedonism + Intentional*
...
**2. The Tribal Hedonist (+Y, +X, -Z)**
*Structure + Hedonism + Organic*
...
*Structure + Emotional Depth + Intentional*
...
*Structure + Emotional Depth + Organic*
...
*Autonomy + Emotional Depth + Intentional*
...
*Autonomy + Emotional Depth + Organic*
...
*   **Bound Dot:** Lands in "The Anchored Play Couple" (+Y, +X, +Z). *When pair-bonded, I become highly structured and intentional about how we play together as a team.*
